...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
        {/* CTA Section */}
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center gap-12">
              ...
              <div className="flex flex-col items-center ml-0 md:ml-8 mt-8 md:mt-0">
                ...
                <div className="flex gap-4 flex-wrap justify-center">
                  <img src={appstore} alt="Apple App Store" className="h-12 w-auto object-contain" />
                  <img src={playstore} alt="Google Play Store" className="h-12 w-auto object-contain" />
                </div>
              </div>
            </div>
          </div>
